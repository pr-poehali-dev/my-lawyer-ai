  ...
  const services = [
    {
      ...
      description:
        "Ответы на вопросы по гражданским спорам, защите прав и интересов",
    },
    {
      icon: "Briefcase",
      title: "Корпоративное право",
      description:
        "Юридические вопросы для бизнеса, договоры, регистрация компаний",
    },
    {
      icon: "Home",
      title: "Недвижимость",
      description:
        "Консультации по сделкам с недвижимостью и оформлению документов",
    },
    {
      icon: "Users",
  ...
  const faqItems = [
    {
      ...
      answer:
        "ИИ использует технологию RAG (Retrieval-Augmented Generation) - сначала находит релевантные статьи законов в базе данных, затем YandexGPT формирует ответ на основе этих конкретных статей. Все ответы основаны на реальных источниках российского законодательства с указанием конкретных номеров статей.",
    },
    {
      question: "Бесплатно ли пользоваться сервисом?",
      answer:
        "Да, ИИ-консультант полностью бесплатный. Вы можете задавать неограниченное количество юридических вопросов.",
    },
    {
      question: "Как быстро я получу ответ?",
      answer:
        "ИИ-помощник отвечает практически мгновенно — обычно это занимает 5-10 секунд.",
    },
    {
      question: "Насколько точны ответы ИИ?",
      answer:
        "Модель обучена на актуальном российском законодательстве и судебной практике. Однако для сложных случаев и важных решений рекомендуем также проконсультироваться с практикующим юристом.",
    },
    {
      question: "Какие вопросы можно задавать?",
      answer:
        "Любые вопросы, связанные с российским правом: гражданское, трудовое, семейное, уголовное, корпоративное право, недвижимость, налоги и другие области.",
    },
    {
      question: "Заменяет ли ИИ реального юриста?",
      answer:
        "ИИ дает первичную консультацию и помогает разобраться в ситуации, но не заменяет профессионального юриста в сложных делах, судебных процессах или официальном представительстве.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Получите мгновенные ответы на юридические вопросы от
                специализированного ИИ, обученного на российском
                законодательстве
              </p>
      ...
      <section id="about" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            "Мой юрист" — это специализированная модель YandexGPT, дообученная
            на российском законодательстве. ИИ-помощник дает первичные
            юридические консультации, помогает разобраться в правовых вопросах и
            понять свои права. Работает круглосуточно и абсолютно бесплатно.
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-500">
                ИИ-помощник для юридических консультаций на основе российского
                законодательства
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>© 2025 Мой юрист. ИИ-помощник для юридических консультаций.</p>
          </div>
        </div>
      </footer>
    </div>
